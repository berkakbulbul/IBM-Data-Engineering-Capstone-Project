...
# Connect to MySQL
connection = mysql.connector.connect(user='root', password='NDUtYmVya3hwLTE4',host='127.0.0.1',database='sales')
...
dsn_uid = "jpw33976"        # e.g. "abc12345"
dsn_pwd = "vR7vOKuiFPKPb9WV"      # e.g. "7dBZ3wWt9XN6$o0J"
